...
const addReminders = () => {
  ...
  switch (getCurrentLocation()) {
    ...
    case 'queso_geyser':
      ...
      if (user.quests?.QuestQuesoCanyon?.is_wild_tonic_active || user.quests?.QuestQuesoGeyser?.is_wild_tonic_enabled) {
    ...
    case 'winter_hunt_fortress':
      ...
      if (user.quests?.QuestCinnamonTreeGrove?.is_fuel_enabled || user.quests?.QuestGolemWorkshop?.is_fuel_enabled || user.quests?.QuestIceFortress?.is_fuel_enabled) {
